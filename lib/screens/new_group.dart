      ...
      body: Stack(
        children: [
                              ...
                              return InkWell(
                                onTap: () {
                                  setState(() {
                                    ...
                                    selectedContect
                                        .remove(selectedContect[index]);
                                  });
                                },
                                child: SelectedAvtaar(
                                    chatModel: selectedContect[index]),
                              );
                            })),
                    const Divider(
                      thickness: 1,
          ...
          Positioned(
            bottom: 16,
            right: 16,
            child: selectedContect.isNotEmpty
